...
import { type RestaurantBookingContext } from '../lib/bookingContext';
import {
...
export function RestaurantDetailScreen({ route, navigation }: ScreenProps) {
  ...
  // Table / normal reservation only — not eventId. For events use EventDetail.
  const _restaurantBooking: RestaurantBookingContext = {
    type: 'RESTAURANT',
    restaurantId,
  };
  void _restaurantBooking;
